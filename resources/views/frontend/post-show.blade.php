      ...
      <div class="col-lg-4">
        <div class="sidebar">
              ...
              <div class="tab-content">
                ...
                <div id="popular" class="container tab-pane fade show active">
                  ...
                  <div class="tn-news">
                    ...
                    <div class="tn-title">
                      <a href="{{ route('frontend.show',['slug'=>$post->slug]) }}">{{ $post->title }} ({{ $post->comments->count() }})</a>
                    </div>
                  </div>
                  @endforeach
                </div>
          ...
          <div class="sidebar-widget">
            ...
            <div class="category">
              <ul>
                ...
                <li><a href="{{ route('frontend.category',['slug'=>$category->slug]) }}">{{ $category->name }}</a><span>{{ $category->posts_count }}</span></li>
                @endforeach
              </ul>
            </div>
          </div>
          ...
          <div class="sidebar-widget">
            ...
            <div class="tags">
              @foreach ($categories_with_posts_count as $category)
              <a href="{{ route('frontend.category',['slug'=>$category->slug]) }}">{{ $category->name }} {{ $category->posts_count }}</a>
              @endforeach
            </div>
          </div>
        </div>
