                ...
                <div id="popular" class="container tab-pane fade">
                  @foreach ($popular_three_news as $post)
                    <div class="tn-news">
                      ...
                      <div class="tn-title">
                        <a href="{{ route('frontend.show', ['slug' => $post->slug]) }}"
                          target="_blank">{{ $post->title }}({{ $post->comments->count() }})</a>
                      </div>
                    </div>
                  @endforeach
                </div>
                ...
                <div id="m-read" class="container tab-pane fade">
                  @foreach ($top_three_posts as $post)
                    <div class="tn-news">
                      ...
                      <div class="tn-title">
                        <a href="{{ route('frontend.show', ['slug' => $post->slug]) }}"
                          target="_blank">{{ $post->title }}({{ $post->clicked }})</a>
                      </div>
                    </div>
                  @endforeach
                </div>
              ...
              <div class="mn-list">
                ...
                <ul>
                  @foreach ($read_more_posts as $post)
                    <li><a href="{{ route('frontend.showById', ['id' => $post->id]) }}" target="_blank">{{ $post->title }}</a>
                    </li>
                  @endforeach
                </ul>
              </div>
